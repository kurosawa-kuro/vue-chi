        ...
        <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
          ...
          <div class="flex-1">
            ...
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
              ...
              <div class="text-sm">
                Have an account? <router-link class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" to="/signin">Sign In</router-link>
              </div>
            </div>
              ...
              <div class="max-w-md mx-auto w-full">
                <div class="relative">
                  ...
                  <ul class="relative flex justify-between w-full">
                    ...
                    <li>
                      <router-link class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400" to="/onboarding-02">2</router-link>
                    </li>
                    <li>
                      <router-link class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400" to="/onboarding-03">3</router-link>
                    </li>
                    <li>
              ...
              <form>
                <div class="space-y-3 mb-8">
                  <label class="relative block cursor-pointer">
                    ...
                    <div class="flex items-center bg-white text-sm font-medium text-gray-800 dark:text-gray-100 p-4 rounded-lg dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs transition">
                ...
                <div class="flex items-center justify-between">
                  <router-link class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white ml-auto" to="/onboarding-02">Next Step -&gt;</router-link>
                </div>
              </form>
