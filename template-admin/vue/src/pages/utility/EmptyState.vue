        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
          <div class="max-w-2xl m-auto mt-16">
            ...
            <div class="text-center px-4">
              <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-linear-to-t from-gray-200 to-gray-100 dark:from-gray-700 dark:to-gray-800 mb-4">
