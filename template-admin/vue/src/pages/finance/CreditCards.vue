    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-white dark:bg-gray-900">
      ...
      <main class="grow">
        ...
        <div class="lg:relative lg:flex">
          ...
          <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
            ...
            <div class="sm:flex sm:justify-between sm:items-center mb-5">
              ...
              <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Cards</h1>
              </div>

              <!-- Add card button -->
              <button class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Add Card</button>
            ...
            <div class="mb-5">
              <ul class="flex flex-wrap -m-1">
                ...
                <li class="m-1">
                  <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition">Physical Cards</button>
                </li>
                <li class="m-1">
                  <button class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition">Virtual Cards</button>
                </li>
              </ul>
            </div>
            ...
            <div class="space-y-2">
              ...
              <label class="relative block cursor-pointer text-left w-full">
                ...
                <div class="p-4 rounded-lg dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs transition">
                  <div class="grid grid-cols-12 items-center gap-x-2">
                    ...
                    <div class="col-span-6 order-1 sm:order-none sm:col-span-3 flex items-center space-x-4 lg:sidebar-expanded:col-span-6 xl:sidebar-expanded:col-span-3">
                      ...
                      <div>
                        <div class="text-sm font-medium text-gray-800 dark:text-gray-100">_Metal</div>
                    ...
                    <div class="col-span-6 order-2 sm:order-none sm:col-span-3 text-left sm:text-center lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                      <div class="text-sm font-medium text-gray-800 dark:text-gray-100 truncate">Dominik Lamakani</div>
                    </div>
                    <!-- Card limits -->
                ...
                <div class="p-4 rounded-lg dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs transition">
                  <div class="grid grid-cols-12 items-center gap-x-2">
                    ...
                    <div class="col-span-6 order-1 sm:order-none sm:col-span-3 flex items-center space-x-4 lg:sidebar-expanded:col-span-6 xl:sidebar-expanded:col-span-3">
                      ...
                      <div>
                        <div class="text-sm font-medium text-gray-800 dark:text-gray-100">_Virtual</div>
                    ...
                    <!-- Card status -->
                    <div class="col-span-6 order-2 sm:order-none sm:col-span-2 text-right lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                      <div class="text-xs inline-flex font-medium bg-yellow-500/20 text-yellow-700 rounded-full text-center px-2.5 py-1">Blocked</div>
                    </div>
                  </div>
                </div>
                <div class="absolute inset-0 border-2 border-transparent peer-checked:border-violet-400 dark:peer-checked:border-violet-500 rounded-lg pointer-events-none" aria-hidden="true"></div>
          ...
          <!-- Sidebar -->
          <div>
            <div class="lg:sticky lg:top-16 bg-linear-to-b from-gray-100 to-white dark:from-gray-800/30 dark:to-gray-900 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-700/60 lg:w-[390px] lg:h-[calc(100dvh-64px)]">
              <div class="py-8 px-4 lg:px-8">
                <div class="max-w-sm mx-auto lg:max-w-none">

                  <div class="text-gray-800 dark:text-gray-100 font-semibold text-center mb-6">Physical Metal Card Summary</div>
                  ...
                  <!-- Details -->
                  <div class="mt-6">
                    <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-1">Details</div>
                    <ul>
                      <li class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                        ...
                        <div class="text-sm font-medium text-gray-800 dark:text-gray-100 ml-2">Physical Metal Card</div>
                      </li>
                      <li class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                        <div class="text-sm">Status</div>
                        <div class="flex items-center whitespace-nowrap">
                          <div class="w-2 h-2 rounded-full bg-green-500 mr-2"></div>
                          <div class="text-sm font-medium text-gray-800 dark:text-gray-100">Active</div>
                        </div>
                      </li>
                    </ul>
                  </div>
                  ...
                  <!-- Payment Limits -->
                  <div class="mt-6">
                    <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4">Payment Limits</div>
                    <div class="pb-4 border-b border-gray-200 dark:border-gray-700/60">
                      <div class="flex justify-between text-sm mb-2">
                        <div>Spent This Month</div>
                        <div class="italic">$750,00 <span class="text-gray-400 dark:text-gray-500">/</span> $1,500.00</div>
                      </div>
                  ...
                  <!-- Withdrawal Limits -->
                  <div class="mt-6">
                    <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4">Withdrawal Limits</div>
                    <div class="pb-4 border-b border-gray-200 dark:border-gray-700/60">
                      <div class="flex justify-between text-sm mb-2">
                        <div>Withdrawn This Month</div>
                        <div class="italic">$100,00 <span class="text-gray-400 dark:text-gray-500">/</span> $1,500.00</div>
                      </div>
                      <div class="relative w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full">
                        <div class="absolute inset-0 bg-green-400 rounded-full" aria-hidden="true" style="width: 7.5%;"></div>
                      </div>
                    </div>
                  </div>
