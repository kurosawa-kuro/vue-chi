      ...
      <main class="grow">
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
          ...
          <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
              <div class="mb-6">
                <router-link class="btn-sm px-3 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" to="/community/meetups">
              ...
              <div class="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                ...
                <div class="flex items-center sm:mr-4">
                  <a class="block mr-2 shrink-0" href="#0">
                    <img class="rounded-full" src="../../images/user-32-07.jpg" width="32" height="32" alt="User 04" />
                  </a>
              ...
              <!-- Image -->
              <figure class="mb-6">
                <img class="w-full rounded-xs" src="../../images/meetup-image.jpg" width="640" height="360" alt="Meetup" />
              </figure>

              <!-- Post content -->
              <div>
                <h2 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">Meetup Details</h2>
              ...
              <div>
                ...
                <div class="grid grid-cols-3 gap-4 my-6">
                  <a class="block" href="#0">
                    <img class="w-full rounded-xs" src="../../images/meetup-photo-01.jpg" width="203" height="152" alt="Meetup photo 01" />
                  </a>
                  <a class="block" href="#0">
                    <img class="w-full rounded-xs" src="../../images/meetup-photo-02.jpg" width="203" height="152" alt="Meetup photo 02" />
                  </a>
                  <a class="block" href="#0">
                    <img class="w-full rounded-xs" src="../../images/meetup-photo-03.jpg" width="203" height="152" alt="Meetup photo 03" />
                  </a>
                </div>
              </div>
              ...
              <!-- Comments -->
              <div>
                <h2 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">Comments (3)</h2>
                <ul class="space-y-5 my-6">
                  <!-- Comment -->
                  <li class="flex items-start">
                    <a class="block mr-3 shrink-0" href="#0">
                      <img class="rounded-full" src="../../images/user-32-07.jpg" width="32" height="32" alt="User 07" />
                    </a>
                    <div class="grow">
                      <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2">Taylor Nieman</div>
                  ...
                  <li class="flex items-start">
                    <a class="block mr-3 shrink-0" href="#0">
                      <img class="rounded-full" src="../../images/user-32-08.jpg" width="32" height="32" alt="User 08" />
                    </a>
                    <div class="grow">
                      <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2">Meagan Loyst</div>
                      <div class="italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.”</div>
                    </div>
                  </li>
                  <!-- Comment -->
                  <li class="flex items-start">
                    <a class="block mr-3 shrink-0" href="#0">
                      <img class="rounded-full" src="../../images/user-32-02.jpg" width="32" height="32" alt="User 02" />
                    </a>
                    <div class="grow">
                      <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2">Frank Malik</div>
                      <div class="italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.”</div>
                    </div>
                  </li>
                </ul>
              ...
              <!-- Similar Meetups -->
              <div>
                <h2 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">Similar Meetups</h2>
              ...
              <div class="bg-white dark:bg-gray-800 p-5 shadow-xs rounded-xl lg:w-72 xl:w-80">
                <div class="space-y-2">
                  ...
                  <button class="btn w-full border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300">
                    <svg class="fill-red-500 shrink-0" width="16" height="16" viewBox="0 0 16 16">
                  ...
                  <li>
                    <div class="flex justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Carolyn McNeail</span>
                        </div>
                      </div>
                  ...
                  <li>
                    <div class="flex justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Ivan Mesaros</span>
                        </div>
                      </div>
                      <button class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 rounded-full">
                        <span class="sr-only">Menu</span>
                  ...
                  <li>
                    <div class="flex justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Maria Martinez</span>
                        </div>
                      </div>
                      <button class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 rounded-full">
                        <span class="sr-only">Menu</span>
                  ...
                  <li>
                    <div class="flex items-center justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Haruki Masuno</span>
                        </div>
                      </div>
                      <button class="btn-xs text-xs border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 px-2.5 py-1 rounded-full shadow-none">Invite</button>
                    </div>
                  </li>
                  <li>
                    <div class="flex items-center justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Joe Huang</span>
                        </div>
                      </div>
                      <button class="btn-xs text-xs border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 px-2.5 py-1 rounded-full shadow-none">Invite</button>
                    </div>
                  ...
                  <li>
                    <div class="flex items-center justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Lisa Sitwala</span>
                        </div>
                      </div>
                      <button class="btn-xs text-xs border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 px-2.5 py-1 rounded-full shadow-none">Invite</button>
                    </div>
