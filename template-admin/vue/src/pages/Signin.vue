          ...
          <div class="max-w-sm mx-auto w-full px-4 py-8">
            ...
            <form>
              ...
              <div class="flex items-center justify-between mt-6">
                ...
                <router-link class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white whitespace-nowrap ml-3" to="/">Sign In</router-link>
              </div>
            </form>
            <!-- Footer -->
            <div class="pt-5 mt-6 border-t border-gray-200 dark:border-gray-700">
              <div class="text-sm">
                Don’t you have an account? <router-link class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" to="/signup">Sign Up</router-link>
              </div>
              <!-- Warning -->
              <div class="mt-5">
