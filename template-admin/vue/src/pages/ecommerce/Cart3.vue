              ...
              <div class="mb-6 lg:mb-0">
                <div class="mb-3">
                  <div class="flex text-sm font-medium text-gray-400 dark:text-gray-500 space-x-2">
                    ...
                    <span>-&gt;</span>
                    <span class="text-violet-500">Confirm</span>
                  </div>
                </div>
                <header class="mb-6">
                  <!-- Title -->
                  <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold mb-2">Thank you for your order</h1>
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                        <div class="flex-1">
                          ...
                          <input id="card-name" class="form-input w-full" type="text" value="Patrick" />
                        </div>
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-surname">Surname</label>
                          <input id="card-surname" class="form-input w-full" type="text" value="Sullivan" />
                        </div>
                      </div>
                      <!-- 2nd row -->
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-state">State/Country</label>
                      ...
                      <div class="text-right">
                        <button type="submit" class="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300">Download Invoice</button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <!-- Billing footer -->
                <div class="bg-gray-50 dark:bg-gray-800/30 rounded-sm border border-gray-200 dark:border-gray-700/60 p-4">
                  <div class="text-center md:text-left md:flex md:items-center md:justify-between space-y-2 md:space-y-0 md:space-x-2">
                    <div class="text-sm">Enjoy a <span class="font-medium text-gray-800 dark:text-gray-100">20% OFF</span> discount on your next order 🎉</div>
                    <div class="relative inline-flex text-center px-3 py-1 rounded-sm bg-green-500">
                      <div class="absolute w-3 h-3 rounded-full bg-white dark:bg-gray-800 left-0 -translate-x-1/2 top-1/2 -translate-y-1/2" aria-hidden="true"></div>
                      <div class="absolute w-3 h-3 rounded-full bg-white dark:bg-gray-800 right-0 translate-x-1/2 top-1/2 -translate-y-1/2" aria-hidden="true"></div>
                ...
                <div class="max-w-sm mx-auto lg:max-w-none">
                  ...
                  <div class="space-y-6">
                    ...
                    <div>
                      ...
                      <ul>
                        ...
                        <li class="flex items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
                          <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                            <img class="w-16 xl:w-20" src="../../images/related-product-01.jpg" width="200" height="142" alt="Product 01" />
                          </a>
                          <div class="grow">
                            <a href="#0">
                        ...
                        <li class="flex items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
                          <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                            <img class="w-16 xl:w-20" src="../../images/related-product-02.jpg" width="200" height="142" alt="Product 02" />
                          </a>
                          <div class="grow">
                            <a href="#0">
                        ...
                        <li class="flex items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
                          <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                            <img class="w-16 xl:w-20" src="../../images/related-product-03.jpg" width="200" height="142" alt="Product 03" />
                          </a>
                          <div class="grow">
                            <a href="#0">
                      ...
                      <ul>
                        <li class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                          ...
                          <div class="text-sm font-medium text-gray-800 dark:text-gray-100 ml-2">$205</div>
                        </li>
                        <li class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                          <div class="text-sm">Taxes</div>
                          <div class="text-sm font-medium text-gray-800 dark:text-gray-100 ml-2">$48</div>
                        </li>
                        <li class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                          <div class="flex items-center">
                            <span class="text-sm mr-2">Discount</span>
                            <span class="text-xs inline-flex whitespace-nowrap font-medium uppercase bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-full text-center px-2.5 py-1">XMAS22</span>
                          </div>
                          <div class="text-sm font-medium text-gray-800 dark:text-gray-100 ml-2">-$25</div>
                        </li>
                        <li class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                    ...
                    <div>
                      ...
                      <div class="text-sm rounded-sm border border-gray-200 dark:border-gray-700/60 p-3">
                        <div class="flex items-center justify-between space-x-2">
                          <!-- CC details -->
                          <div class="flex items-center">
                            <!-- Mastercard icon -->
                            <svg class="shrink-0 mr-3" width="32" height="24" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M15.977 7.578A5.667 5.667 0 0 0 13.867 12c0 1.724.777 3.353 2.11 4.422A5.667 5.667 0 0 0 18.087 12a5.667 5.667 0 0 0-2.11-4.422Z" fill="#F26622" />
                            </svg>
                            <div>Ending with <span class="text-gray-800 dark:text-gray-100">2478</span></div>
                          </div>
                          <!-- Expiry -->
                    ...
                    <div class="mt-6">
                      <div class="mb-4">
                        <router-link to="/ecommerce/pay" class="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">View Your Order</router-link>
                      </div>
                      <div class="text-xs text-gray-500 italic text-center">Should you ever change your mind, we offer a 14-day, no-questions-asked refund policy.</div>
                    </div>
