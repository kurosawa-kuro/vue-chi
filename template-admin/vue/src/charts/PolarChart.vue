...
export default {
  ...
  setup(props) {
    ...
    const { gridColor, textColor, backdropColor, tooltipTitleColor, tooltipBodyColor, tooltipBgColor, tooltipBorderColor } = getChartColors()
          ...
          scales: {
            r: {
              ...
              ticks: {
                ...
                backdropColor: darkMode.value ? backdropColor.dark : backdropColor.light,
              },
            },
          },            
          plugins: {
