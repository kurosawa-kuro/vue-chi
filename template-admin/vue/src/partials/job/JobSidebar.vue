      ...
      <div class="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
        ...
        <div>
          ...
          <div class="flex items-center">
            ...
            <div class="text-sm text-gray-400 dark:text-gray-500 italic ml-2">{{companySetting}}</div>
          </div>
        ...
        <div>
          ...
          <div class="flex items-center">
            ...
            <div class="text-sm text-gray-400 dark:text-gray-500 italic ml-2">{{immigrationSetting}}</div>
          </div>
