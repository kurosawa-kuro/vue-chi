<template>
  <!-- Card 1 -->
  <div class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-800 shadow-xs rounded-xl dark:border-transparent overflow-hidden">
    <!-- Image -->
    ...
    <!-- Gradient -->
    <div class="absolute inset-0 bg-linear-to-t from-gray-800 to-transparent" aria-hidden="true"></div>
    <!-- Content -->
    <div class="relative h-full p-5 flex flex-col justify-end">
      ...
      <a class="text-sm font-medium text-violet-400 hover:text-violet-300" href="#0">Explore -&gt;</a>
    </div>
  </div>
