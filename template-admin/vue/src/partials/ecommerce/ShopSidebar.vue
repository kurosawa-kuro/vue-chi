  ...
  <div>
    <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5 min-w-60">
      <div class="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
        ...
        <!-- Price Range -->
        <div>
          <div class="text-sm text-gray-800 dark:text-gray-100 font-semibold mb-3">Price Range</div>
        ...
        <!-- Group 3 -->
        <div>
          <div class="text-sm text-gray-800 dark:text-gray-100 font-semibold mb-3">Multi Select</div>
          <ul class="space-y-2">
            <li>
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox" />
                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Apps / Software</span>
              </label>
            </li>
            <li>
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox" />
                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Education</span>
              </label>
            </li>
            <li>
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox" />
                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Books & Writing</span>
              </label>
            </li>
            <li>
              <label class="flex items-center">
        ...
        <!-- Group 4 -->
        <div>
          <div class="text-sm text-gray-800 dark:text-gray-100 font-semibold mb-3">Sort By Rating</div>
          <ul class="space-y-2">
            <li>
              <!-- Rating button -->
              <button class="flex items-center space-x-2 mr-2">
                ...
                <div class="inline-flex text-sm text-gray-500 dark:text-gray-400 italic"><span class="sr-only">4 Stars</span> And up</div>
              </button>
            </li>
            <li>
              <!-- Rating button -->
              <button class="flex items-center space-x-2 mr-2">
                ...
                <div class="inline-flex text-sm text-gray-500 dark:text-gray-400 italic"><span class="sr-only">3 Stars</span> And up</div>
              </button>
            </li>
            <li>
              <!-- Rating button -->
              <button class="flex items-center space-x-2 mr-2">
                ...
                <div class="inline-flex text-sm text-gray-500 dark:text-gray-400 italic"><span class="sr-only">2 Stars</span> And up</div>
              </button>
            </li>
            <li>
              <!-- Rating button -->
              <button class="flex items-center space-x-2 mr-2">
                ...
                <div class="inline-flex text-sm text-gray-500 dark:text-gray-400 italic"><span class="sr-only">1 Stars</span> And up</div>
              </button>
            </li>
          </ul>
        </div>
