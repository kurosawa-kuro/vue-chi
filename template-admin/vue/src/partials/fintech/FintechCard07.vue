  ...
  <div class="flex flex-col col-span-full sm:col-span-12 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    ...
    <div class="px-5 py-3">
        ...
        <div class="flex items-center">
            ...
            <div class="text-sm"><span class="font-medium text-yellow-600">97.4%</span></div>
        </div>
...
import LineChart from '../../charts/LineChart06.vue'
