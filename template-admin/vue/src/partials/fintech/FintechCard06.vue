        ...
        <table class="table-auto w-full dark:text-gray-300">
          ...
          <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
            ...
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-green-600 text-right">+$1,299.22</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-gray-800 dark:text-gray-100">Web.com</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div>Qonto</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-green-600 text-right">+$1,200.88</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-gray-800 dark:text-gray-100">Github Inc.</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div>N26</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-green-600 text-right">+$499.99</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-green-600 text-right">+$2,179.36</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-green-600 text-right">+$249.88</div>
              </td>
            </tr>
          </tbody>
        </table>
