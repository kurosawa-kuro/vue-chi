        ...
        <table class="table-auto w-full dark:text-gray-300">
          ...
          <tbody class="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
            ...
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left text-green-500">+$4.20 (4%)</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap md:w-1/2">
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="text-gray-800 dark:text-gray-100 uppercase">Fb</div>
                    <div class="text-xs text-gray-500">Meta Inc.</div>
                  </div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left text-green-500">+$12.20 (3.7%)</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap md:w-1/2">
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="text-gray-800 dark:text-gray-100 uppercase">Googl</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left text-red-500">-$12.20 (3.7%)</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap md:w-1/2">
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="text-gray-800 dark:text-gray-100 uppercase">Aapl</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left text-green-500">+$7.44 (1.4%)</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap md:w-1/2">
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="text-gray-800 dark:text-gray-100 uppercase">Coin</div>
                    <div class="text-xs text-gray-500">Coinbase Global Inc.</div>
                  </div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left text-red-500">-$24,30 (6.2%)</div>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    const buildChartData = (chart) => {
      var obj = {
        ...
        datasets: [
          ...
          {
            data: chart.data,
            borderColor: chart.growth ? getCssVariable('--color-green-500') : getCssVariable('--color-rose-500'),
            borderWidth: 2,
            pointRadius: 0,
            pointHoverRadius: 3,
            pointBackgroundColor: chart.growth ? getCssVariable('--color-green-500') : getCssVariable('--color-rose-500'),
            clip: 20,
            tension: 0.2,
          },
        ],      
