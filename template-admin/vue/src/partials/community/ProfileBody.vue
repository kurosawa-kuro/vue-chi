      ...
      <div class="-mt-16 mb-6 sm:mb-3">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
          ...
          <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
            <img class="rounded-full border-4 border-white dark:border-gray-900" src="../../images/user-128-01.jpg" width="128" height="128" alt="Avatar" />
          </div>
            ...
            <div class="grid xl:grid-cols-2 gap-4">
              ...
              <div class="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-xs">
                ...
                <div class="grow flex items-center truncate mb-2">
                  <div class="w-8 h-8 shrink-0 flex items-center justify-center bg-gray-700 rounded-full mr-2">
                    <img class="ml-1" src="../../images/icon-03.svg" width="14" height="14" alt="Icon 03" />
                  </div>
                  <div class="truncate">
                    <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Acme Marketing</span>
                  </div>
                </div>
                <!-- Card content -->
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex -space-x-3 -ml-0.5">
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-02.jpg" width="24" height="24" alt="Avatar" />
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-03.jpg" width="24" height="24" alt="Avatar" />
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-04.jpg" width="24" height="24" alt="Avatar" />
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-05.jpg" width="24" height="24" alt="Avatar" />
                  </div>
                  <!-- Link -->
                  <div>
              ...
              <div class="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-xs">
                ...
                <div class="grow flex items-center truncate mb-2">
                  ...
                  <div class="truncate">
                    <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Acme Product</span>
                  </div>
                </div>
                <!-- Card content -->
                <div class="text-sm mb-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</div>
                ...
                <div class="flex justify-between items-center">
                  <!-- Avatars group -->
                  <div class="flex -space-x-3 -ml-0.5">
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-06.jpg" width="24" height="24" alt="Avatar" />
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-03.jpg" width="24" height="24" alt="Avatar" />
                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content" src="../../images/avatar-01.jpg" width="24" height="24" alt="Avatar" />
                  </div>
                  <!-- Link -->
                  <div>
                    <a class="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">View -&gt;</a>
            ...
            <div class="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-xs">
              <ul class="space-y-3">
                ...
                <li class="sm:flex sm:items-center sm:justify-between">
                  <div class="sm:grow flex items-center text-sm">
                    <!-- Icon -->
                    <div class="w-8 h-8 rounded-full shrink-0 bg-violet-500 my-2 mr-3">
                      <svg class="w-8 h-8 fill-current text-violet-50" viewBox="0 0 32 32">
                    ...
                    <!-- Position -->
                    <div>
                      <div class="font-medium text-gray-800 dark:text-gray-100">Product Designer</div>
                      <div class="flex flex-nowrap items-center space-x-2 whitespace-nowrap">
                        <div>Milan, IT</div>
                        <div class="text-gray-400 dark:text-gray-600">·</div>
