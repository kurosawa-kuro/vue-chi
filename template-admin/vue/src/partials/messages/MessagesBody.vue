<template>
  <div class="grow px-4 sm:px-6 md:px-5 py-6">
    ...
    <div class="flex items-start mb-4 last:mb-0">
      ...
      <div>
        <div
          class="text-sm bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 p-3 rounded-lg rounded-tl-none mb-1">
    ...
    <div class="flex items-start mb-4 last:mb-0">
      ...
      <div>
        <div
          class="text-sm bg-violet-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent mb-1">
    ...
    <div class="flex items-start mb-4 last:mb-0">
      ...
      <div>
        <div class="flex items-center">
          <img class="rounded-lg shadow-xs mb-1" src="../../images/chat-image.jpg" width="240" height="180"
            alt="Chat image" />
          <button
    ...
    <div class="flex justify-center">
      <div
        class="inline-flex items-center justify-center text-xs text-gray-600 dark:text-gray-400 font-medium px-2.5 py-1 bg-white dark:bg-gray-700 shadow-xs rounded-full my-5">
        Tuesday, 20 January
      </div>
    </div>
    <!-- Chat msg -->
    <div class="flex items-start mb-4 last:mb-0">
      ...
      <div>
        <div
          class="text-sm bg-violet-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent mb-1">
          Can you join <a class="font-medium" href="#0">@dominik</a>? <a class="underline"
            href="#0">https://meet.google.com/haz-r3gt-idj</a>
        </div>
        <div class="flex items-center justify-between">
